...
class PAT_Loader {
	...
	public static function init(): void {
		$files = array(
			...
			PAT_PLUGIN_PATH . 'includes/support/class-pat-save-history-store.php',
			...
			PAT_PLUGIN_PATH . 'includes/controllers/class-pat-undo-controller.php',
			PAT_PLUGIN_PATH . 'includes/controllers/class-pat-history-controller.php',
