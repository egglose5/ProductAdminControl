	...
	public function enqueue_assets( string $hook_suffix ): void {
		...
		wp_localize_script(
			...
			array(
				...
				'undoAction'          => class_exists( 'PAT_Undo_Controller' ) ? PAT_Undo_Controller::AJAX_ACTION : '',
				'undoNonce'           => class_exists( 'PAT_Undo_Controller' ) ? wp_create_nonce( PAT_Undo_Controller::NONCE_ACTION ) : '',
				'undoNonceField'             => class_exists( 'PAT_Undo_Controller' ) ? PAT_Undo_Controller::NONCE_FIELD : 'nonce',
				'historyAction'              => class_exists( 'PAT_History_Controller' ) ? PAT_History_Controller::AJAX_ACTION : '',
				'historyNonce'               => class_exists( 'PAT_History_Controller' ) ? wp_create_nonce( PAT_History_Controller::NONCE_ACTION ) : '',
				'historyNonceField'          => class_exists( 'PAT_History_Controller' ) ? PAT_History_Controller::NONCE_FIELD : 'nonce',
